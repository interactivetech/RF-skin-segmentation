...
//
//  RFcolordetection.cpp
//  OPenCV test
//
//  Created by Andrew Mendez on 3/14/14.
//
//
#include "RFcolordetection.h"
...
#define _ERT_ 1 // extremely randomized trees
...
int main()
{
    ...
    params=CvRTParams( 10, // max_depth,
     1, // min_sample_count,
     0.f, // regression_accuracy,
     false, // use_surrogates,
     2, // max_categories,
     ...
     false, // calc_var_importance,
     1, // nactive_vars,
     2, // max_num_of_trees_in_the_forest,
     0, // forest_accuracy,
     CV_TERMCRIT_ITER // termcrit_type
     );
//
	//rtrees.load("/Users/andrewmendez/Desktop/VisionGlasses/training/resultX_IHSL_Laplacian_BGR.xml");

	//rtrees.load("/Users/andrewmendez/Desktop/VisionGlasses/training/resultX_IHSL_Laplacian_BGR_YCrCb2.xml");

	rtrees.load("/Users/andrewmendez/Desktop/VisionGlasses/training/result_IHSL_Laplacian_BGR_YCrCb2.xml");

    //rtrees.load("/Users/andrewmendez/Desktop/VisionGlasses/training/result_Laplacian_BGR.xml");
    //playVideo("/Users/andrewmendez/Desktop/VisionGlasses/training/truth.mp4",true,false,10);
    playVideo("/Users/andrewmendez/Desktop/VisionGlasses/training/scene2-camera1.mov",true,false,10);

//
    //playVideo("/Users/andrewmendez/Desktop/UCF 2013-2014/Spring 2014/skin-database/fuesse2_wenigHaut.avi",true,false,10);
    //playVideo2(7);
    
     //playVideo("/Users/andrewmendez/Desktop/VisionGlasses/training/truth.mp4",false,true,10);
	//rtrees.save( "/Users/andrewmendez/Desktop/VisionGlasses/training/resultX_IHSL_Laplacian_BGR.xml" );
    /*cout << "Use:" << endl
